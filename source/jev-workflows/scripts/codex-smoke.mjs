...
try {
  report.initialize=await rpc('initialize',{clientInfo:{name:'jev_plugin_probe',title:'Jev plugin integration test',version:'0.2.0'},capabilities:{experimentalApi:true,requestAttestation:false}});
